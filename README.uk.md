...
Якщо ви використовуєте це програмне забезпечення у своєму дослідженні або проєкті, будь ласка, цитуйте його, використовуючи метадані з файлу `CITATION.cff`.
